...
public class VoteApiDocs extends RestDocsSupport {
        ...
        mockMvc.perform(post("/api/v1/votes/stadiums/{teamId}", 1L)
            ...
            .andDo(document("vote-stadium-create",
                ...
                requestFields(
                    ...
                    fieldWithPath("choices[].courtId").description("구장 ID")
                ),
                pathParameters(
    ...
    void createDateVote() throws Exception {
        ...
        given(voteService.createDateVote(any(VoteDateCreateServiceRequest.class), eq(1L), any()))
            .willReturn(
                new VoteResponse(
                    1L,
                    "연말 행사 투표",
    ...
    void deleteVote() throws Exception {
        ...
        given(voteService.deleteVote(eq(voteId), any()))
            .willReturn(voteId);
    ...
    void updateVote() throws Exception {
        ...
        given(voteService.updateVote(any(VoteUpdateServiceRequest.class), eq(1L), any()))
            .willReturn(
                new VoteResponse(
                    1L,
                    "10월 행사 투표",
