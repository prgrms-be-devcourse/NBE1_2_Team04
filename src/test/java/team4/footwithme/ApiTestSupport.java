...
@WebMvcTest(controllers = {
    VoteApi.class, ChatApi.class, ChatroomApi.class, ChatMemberApi.class, StadiumMerchantApi.class, CourtMerchantApi.class, GameApi.class, ReservationApi.class, MemberApi.class
})
