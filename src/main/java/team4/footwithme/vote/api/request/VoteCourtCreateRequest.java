...
public record VoteCourtCreateRequest(
    ...
    List<CourtChoices> choices
) {
    public VoteCourtCreateServiceRequest toServiceRequest() {
        return new VoteCourtCreateServiceRequest(
            title,
            endAt,
            choices.stream()
